      ...
      <div>
        ...
        {activePage === "framework" && (
            <div id="export-area" className="main-content">
                ...
                {/* Cross-cutting */}
                <div className="section-grid-row">
                <div className="section-header-cell">Cross-cutting</div>
                <div className="cross-subtitle-columns">
                    {Object.entries(groupCrossBySubtitle()).map(([subtitle, items]) => (
                    <div key={subtitle} className="cross-subtitle-column">
                        <div className="cross-subtitle-header">{subtitle}</div>
                        <div className="cross-subtitle-cards">
                        {items.map((el) => {
                            const isSelected = selectedElements.find((sel) => sel.id === el.id);
                            const isRelated = highlighted.includes(el.id);
                            return (
